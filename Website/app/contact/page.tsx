...
export default async function ContactPage({ searchParams }: { searchParams: Promise<{ path?: string }> }) {
  ...
  return (
    <section className="bg-background">
      ...
      <div className="mx-auto grid max-w-[1440px] gap-12 px-4 py-24 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20 lg:px-8 lg:py-32">
        <div>
        ...
        <div className="bezel-shell border border-border bg-card p-1.5">
          <div className="bezel-core p-6 sm:p-8 lg:p-10">
