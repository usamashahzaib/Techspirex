  ...
  return (
    <section className="border-b border-border">
      ...
      <div className="mx-auto max-w-5xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        ...
        <h2 className="reveal-scroll mt-4 font-heading text-4xl font-semibold tracking-tight text-balance sm:text-5xl">The questions worth asking</h2>
        ...
        <div className="reveal-scroll mt-12 divide-y divide-border border-y border-border">
          {faqs.map((faq) => (
            <details key={faq.question} className="group py-6 transition-colors duration-300 ease-[var(--ease-expo-out)] open:bg-muted/30">
              <summary className="flex cursor-pointer list-none items-start justify-between gap-4 font-heading text-lg font-medium tracking-tight [&::-webkit-details-marker]:hidden">
                ...
                <span aria-hidden="true" className="mt-1 shrink-0 font-mono text-xl leading-none text-primary transition-transform duration-400 ease-[var(--ease-expo-out)] group-open:rotate-45">+</span>
              </summary>
