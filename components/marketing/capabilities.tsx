      ...
      <div className="mx-auto max-w-[1400px] px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
        <div className="reveal-scroll grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-24">
          <div className="lg:sticky lg:top-28 lg:self-start">
            <Eyebrow tone="violet">Capabilities</Eyebrow>
            ...
            <Link href={routes.services} className="group mt-8 inline-flex items-center gap-2 text-sm font-extrabold text-brand-violet">
          ...
          <div className="reveal-scroll-stagger divide-y divide-border border-y border-border">
            <Link href={routes.services} className="group grid gap-4 bg-brand-violet px-6 py-10 text-brand-paper transition-[transform,background-color] duration-500 ease-[var(--ease-expo-out)] hover:-translate-y-1 hover:bg-brand-violet-deep sm:grid-cols-[3rem_1fr_auto] sm:items-start">
              ...
              <ArrowRight weight="bold" className="mt-1 size-4 text-brand-cyan transition-transform group-hover:translate-x-1" aria-hidden="true" />
            </Link>

            {supporting.map((item, index) => (
              <Link key={item.href} href={item.href} className="group grid gap-3 px-5 py-7 transition-[background-color,padding] duration-300 hover:bg-brand-cyan/10 sm:grid-cols-[3rem_0.75fr_1.25fr_auto] sm:items-center sm:hover:px-7">
                ...
                <ArrowRight weight="bold" className="size-4 text-brand-violet transition-transform group-hover:translate-x-1" aria-hidden="true" />
              </Link>
            ))}
          </div>
        </div>
